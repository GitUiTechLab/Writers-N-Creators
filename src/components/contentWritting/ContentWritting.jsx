...
import { contentDetails } from "../../constatnts";
          ...
          return (
            <Link to={path} key={id} className='content-card-item'>
              <div className='card-image'>
                <img src={image} alt={header} width={id !== 3 ? 564 : 1268} height={332} />
              </div>
              ...
              <div className='card-lists'>
                {listItems.map((item, idx) => {
                  return (
                    <div key={idx} className='card-list-item flex justify-start items-start'>
