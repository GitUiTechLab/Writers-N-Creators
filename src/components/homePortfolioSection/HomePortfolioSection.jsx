...
import { HomePortfolioContent } from "../../constants";
...
const HomePortfolioSection = () => {
  ...
  return (
    <div className="home-portfolio-section flex items-center flex-col justify-center">
      ...
      <div className="section-sub-header">Past Project Highlights</div>
      ...
      <button className="btn-container" onClick={handleChange}>
        Learn More
      </button>
    </div>
  );
