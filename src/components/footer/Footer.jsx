...
import { footerContent } from '../../constatnts';
        ...
        <div className='footer-content-1'>
            ...
            <div className='content'>
                {footerContent.map((each,idx) => {
                    return (
                        <div className='each-content flex justify-start items-start' key={idx}>
                            <span className='mr-5'>
                            <img src={each.icon} width={16} height={16} alt="icon" />
                            </span>
                            <span className='text-contactUsBtnColor font-[14px] font-inter'>{each.header}</span>
                        </div>
                    )
                })}
            </div>
