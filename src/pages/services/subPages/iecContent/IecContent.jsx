...
import { IceMaterialsContent, ourApproachContent } from "../../../../constants";
  ...
  return (
    <div className="iec-content padding">
      <div className="iec-content-header">
        IEC contents for Panchayati Raj Department, Gov <br />
        of Bihar
      </div>
      <div className="iec-content-overview">
        <div className="header">Overview</div>
        <div className="content">
          Writers N Creators proudly collaborated with the Panchayati Raj
          Department, Government of Bihar, to develop comprehensive IEC
          (Information,
          <br />
          Education, and Communication) materials. Our team worked meticulously
          to create engaging and informative content designed to educate and{" "}
          <br />
      ...
      <div className="iec-content-description mt-10">
        ...
        <div className="description border-l-[1px] border-black ">
          {ourApproachContent.map((each, idx) => {
            ...
            return (
              <div
                className={id % 2 === 0 ? "even-container" : "odd-container"}
              >
                ...
                <div
                  className={
                    id % 2 === 0
                      ? "desc-container ml-5 flex-1"
                      : "desc-container mr-5 flex-1"
                  }
                >
                    ...
                    {content.map((each) => {
                      return (
                        <div className="each-content  flex justify-start items-start m-2">
                          ...
                          <span className="font-inter text-contentFontColor text-[24px]">
                            {each}
                          </span>
                        </div>
                      );
