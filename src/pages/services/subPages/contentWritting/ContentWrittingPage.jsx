...
import { contentWrittingContent } from "../../../../constants";
    ...
    <div className="content-writting-page padding">
      ...
      <div className="overview">
        ...
        <div className="overview-content">
          At Writers N Creators, we specialize in crafting compelling scripts
          that bring important stories to life. One of our notable projects is
          the script writing <br />
          for a short film on Panchayati Raj, undertaken for the BGSYS,
